...
{/*             
            ...
            {isLoading ? (
              ...
              <>
                <Link
                  href="/dashboard"
                  className={`flex items-center space-x-2 px-2 sm:px-3 py-2 text-sm sm:text-base font-medium transition-colors ${
                    isDarkMode
                      ? "text-secondary hover:text-primary"
                      : "text-secondary hover:text-primary"
                  }`}
        ...
        {isMenuOpen && (
          <div className="md:hidden">
            ...
            >
              <Link
                href="/evaluation"
                className={`block px-3 py-2 text-sm sm:text-base font-medium ${
                  isDarkMode
                    ? "text-secondary hover:text-primary"
                    : "text-secondary hover:text-primary"
                }`}
