...
export default function MentorCommentPanel({
  ...
  const userAccess = documentAccess.find(
    (access) => access.mentorId === currentUserId
  );
  const canComment =
    userAccess?.isActive && userAccess?.accessType === "comment";
        ...
        <div className="p-4 bg-blue-50 border-b border-blue-200">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-sm font-medium text-blue-900">
              Access:{" "}
              {userAccess.accessType.charAt(0).toUpperCase() +
                userAccess.accessType.slice(1)}
            </span>
          </div>
