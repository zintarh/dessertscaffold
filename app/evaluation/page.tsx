...
export default function EvaluationPage() {
  ...
  const evaluationData = {
    topic: "The Impact of Artificial Intelligence on Modern Research Methodologies",
    overallScore: 87,
    metrics: [
      {
        name: "Novelty",
        ...
        details: "Your research topic shows good novelty potential. AI's impact on research methodologies is a growing field with room for innovative approaches.",
        recommendations: [
      ...
      },
      {
        ...
        details: "Excellent alignment with current trends. AI in research is highly relevant and gaining significant attention across disciplines.",
        recommendations: [
      ...
      },
      {
        ...
        details: "Strong methodological foundation with clear research design. Your approach demonstrates academic rigor and practical feasibility.",
        recommendations: [
      ...
      },
      {
        ...
        details: "Good identification of research gaps. The intersection of AI and research methodologies presents several unexplored opportunities.",
        recommendations: [
      ...
      },
      {
        ...
        details: "High grant potential due to AI's current relevance and funding priorities. Multiple funding bodies are actively supporting AI research.",
        recommendations: [
      ...
      },
      {
        ...
        details: "Exceptional impact potential. Your research could significantly influence how research is conducted across multiple disciplines.",
        recommendations: [
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <motion.div
                      animate={{ rotate: expandedMetrics.includes(metric.name) ? 180 : 0 }}
